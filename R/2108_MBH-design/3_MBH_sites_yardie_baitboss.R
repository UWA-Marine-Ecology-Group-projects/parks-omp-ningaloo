...
# Data:    BRUVS, BOSS
# Task:    MBH Design Site Selection - Yardie Ck Baited BOSS
...
write.csv(sites_df, 'output/planned/yardie_baitboss_mbh.csv')
...
sites_df$methods   <- c("Baited Boss")
sites_df$method    <- c("BB")
...
shapefile(sites_sp, "output/planned/yardie_baitboss_mbh", overwrite = TRUE)
