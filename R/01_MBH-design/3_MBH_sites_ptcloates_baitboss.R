...
# Data:    BRUVS, BOSS
# Task:    MBH Design Site Selection - Pt Cloates Baited Boss
...
write.csv(sites_df, 'output/planned/ptcloates_baitboss_mbh.csv')
...
shapefile(sites_sp, "output/planned/ptcloates_baitboss_mbh", overwrite = TRUE)
