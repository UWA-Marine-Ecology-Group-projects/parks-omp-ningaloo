...
# Data:    BRUVS, BOSS
# Task:    MBH Design Site Selection - Yardie Ck Flashing BOSS
...
inp_overall <- readRDS("output/yardie_inclusionp_rast.rds")
...
# plot against distribution of covariates
...
write.csv(sites_df, 'output/planned/yardie_flashboss_mbh.csv')
...
sites_df$methods   <- c("Flashing Boss")
sites_df$method    <- c("FB")
...
shapefile(sites_sp, "output/planned/yardie_flashboss_mbh", overwrite = TRUE)
