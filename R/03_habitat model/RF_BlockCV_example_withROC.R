...
text(x=1.2, y=0.95, labels=paste("AUC:", round(roc.invert$auc,2)))

#### AUC of of 1 is perfect predictions ##########
#### a curve close to the diagonal line means predictions are no better than random ######
